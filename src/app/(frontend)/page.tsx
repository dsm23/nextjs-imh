...
import refPQube3r from "~/assets/PQube3r.png";
import refPQube3v from "~/assets/PQube3v.png";
  ...
  <Container>
    <article id="main-content" className="mb-16">
      ...
      <div className="mt-6 grid items-center gap-x-5 gap-y-4 md:grid-cols-2 lg:grid-cols-[3fr_2fr]">
        <div>
          <p className="mt-4">
            IMH Technologies Ltd is the supplier in the UK and Eire for the
            Dranetz range of power quality monitors and Dent Instruments energy
            loggers, plus in the UK, Powerside's (formerly Power Standards Lab)
            range of remote access PQube power monitors. In addition, IMH can
            show the QubeScan and PQView software for controlling a fleet of
            specialist power quality analysers. The combination of the Dranetz
            HDPQ Visa Plus with the Dranview Enterprise Software gives the
            lowest cost system for G5/5 harmonics analysis in the UK.
          </p>

          <p className="mt-4">
            Formed in 1993, IMH Technologies Ltd applies over 30 years of
            experience, to offer an independent power quality consultancy
            service that has benefited major utilities and customers throughout
            the United Kingdom and offshore.
          </p>
          <p className="mt-4">
            IMH offers a full repair and calibration service for our major
            products and holds parts for Dranetz portable instruments.
            Calibration to National Standards is performed at competitive
            prices. We are also experts in configuring our instruments with the
            latest 4G routers - that access the strongest mobile data signal for
            a given location - to give full remote control of our power
            monitors.
          </p>
        </div>
        ...
        <Image
          ...
          alt="3 people round a conference table viewing analytics"
      ...
      <section id="cards">
        ...
        <div className="grid grid-cols-1 gap-2 md:grid-cols-2 lg:grid-cols-3">
          <div className="elevation space-y-4 rounded-sm p-3">
            <h4 className="text-2xl font-bold">
              PQube3 - the power meter for{" "}
            ...
            <ul className="mt-4 ml-5 list-disc space-y-4">
              <li>
                Specially configurable power meter for railway applications,
                tram and metro work
              </li>
              <li>
                Modbus Registers give real-time access to measured parameters to
                integrate with SCADA systems
              </li>
              <li>
                Documentation of voltage drops - to reduce interference in
                escalators
              </li>
              <li>
                Harmonic measurements according to the IEC 61000-4-7 standard -
                ideal for monitoring transformers and rectifiers
              </li>
              <li>
                Easy installation of the power meter in railway substations, on
                control panels, on rectifiers and inverters
              </li>
            </ul>
          </div>
          <div className="elevation space-y-4 rounded-sm p-3">
            <h4 className="text-2xl font-bold">
              PQube3 - the power meter in{" "}
              <span className="text-2xl font-bold text-blue-700">
            ...
            <Image
              src={refPQube3e}
              alt="PQube 3, second orientation"
              className="block"
              placeholder="blur"
            />

            <p>
              Smart grids for generating, storing and consuming electricity
              require monitoring with power analysers
            </p>
            <ul className="mt-4 ml-5 list-disc space-y-4">
              <li>
                Power meter for monitoring various systems in decentralized
                energy generation
              </li>
              <li>Reliably monitor and control smart grids</li>
              <li>
                E-mail notification in the event of malfunctions in
                decentralized energy producers
              </li>
              <li>
                Optimise power grids thanks to detailed reports in daily, weekly
                and monthly trends
              </li>
              <li>
                Solar Panel DC Input voltage and DC current can be measured
                simultaneously with inverter 3 Phase output using just one
                PQube3
              </li>
            </ul>
          </div>
          <div className="elevation space-y-4 rounded-sm p-3">
            <h4 className="text-2xl font-bold">
              PQube3 - the power meter for the{" "}
              <span className="text-2xl font-bold text-blue-700">
                Medical Sector
              </span>
            </h4>
            ...
            <p>
              Electronic devices in medicine are extremely sensitive and require
              highly reliable and stable power supplies
            </p>
            <ul className="ml-5 list-disc space-y-4">
              <li>
                Remote monitoring of electronic devices in hospitals, clinics
                and health centres
              </li>
              <li>Quickly recognise possible imminent faults</li>
              <li>UPS output and standby emergency generator power supply</li>
              <li>
                The power meter helps protect precision electronics and medical
                devices and monitors for harmonics generated by high energy
                X-Ray Machines
              </li>
            </ul>
          </div>
          <div className="elevation space-y-4 rounded-sm p-3">
            ...
            <p>
              Data centres must be continuously supplied with energy by UPS and
              emergency generator power supplies - power analysers detect faults
              at an early stage.
            </p>
            <ul className="ml-5 list-disc space-y-4">
              <li>
                Raw mains, UPS output, UPS efficiency in data centres and other
                information technology facilities is monitored 24/7
              </li>
              <li>
                Local colour screen gives immediate information regarding
                circuit status to on site personnel
              </li>
              <li>Changes in load behaviour are instantly identified</li>
              <li>
                The PQube3 has 2 direct environmental sensor inputs for
                in-cabinet and room temperature determinations, plus additional
                analog inputs for other sensors so that the HEAT produced
                in-situ can be monitored
              </li>
            </ul>
          </div>
          <div className="elevation space-y-4 rounded-sm p-3">
            ...
            <p>
              Faults in the energy supply can destroy the electronics and must
              be detected early with power analysers.
            </p>
            <ul className="ml-5 list-disc space-y-4">
              <li>Power meter for monitoring various electrical parameters</li>
              <li>
                Quickly identify the causes of problems in the energy network
              </li>
              <li>
                Prevent damage to device and machine electronics due to
                disruptions in the energy flow
              </li>
              <li>
                Efficient maintenance of machines thanks to detailed reports
                from the meter - often obtained remotely from capital industrial
                devices installed in customer locations around the world
              </li>
            </ul>
          </div>
          <div className="elevation space-y-4 rounded-sm p-3">
            ...
            <p>
              For on-site measurements, a compact measuring device for field use
              is required.
            </p>

            <ul className="ml-5 list-disc space-y-4">
              <li>
                Mobile power meter for servicing and maintenance of electrical
                systems
              </li>
              <li>
                Integrated reporting function for long-term data and events.
                Comparing week by week and month by month data, fault conditions
                can be predicted
              </li>
              <li>
                Convenient customer service from a distance - monitoring from
                your own computer or smartphone
              </li>
              <li>Cost savings thanks to reduced service visits on site</li>
            </ul>
          </div>
          <div className="elevation space-y-4 rounded-sm p-3">
            <h4 className="text-2xl font-bold">
            ...
            <p>
              In order to guarantee a smooth production process, a stable energy
              network is required. It is how Power Quality affects complicated
              Industrial processes that is of key concern
            </p>
            <ul className="ml-5 list-disc space-y-4">
              <li>
                Monitoring of energy flow and various current values in
                industrial and production systems according to SEMI F47
              </li>
              <li>Power meter for recording 1-phase and 3-phase loads</li>
              <li>
                Recording of environmental values such as temperature, humidity
                and air pressure
              </li>
              <li>Optimizing energy management in production and industry</li>
              <li>
                The PQube3e can monitor 4 separate 3 Phase feeds - all with just
                the one instrument.
              </li>
            </ul>
          </div>
          <div className="elevation space-y-4 rounded-sm p-3">
            ...
            <p>The use of a power meter helps optimize energy consumption.</p>
            <ul className="ml-5 list-disc space-y-4">
              <li>Power meter for sub-metering energy usage.</li>
              <li>
                Detailed information for optimizing the energy demand in any
                facility
              </li>
              <li>
                Measuring and recording of mains voltage quality and harmonic
                content created by the changing load
              </li>
              <li>± 0.1% accuracy from 50Hz to 3000Hz</li>
            </ul>
          </div>
          <div className="elevation space-y-4 rounded-sm p-3">
            <h4 className="text-2xl font-bold">
              PQube3 - the power meter in the{" "}
              <span className="text-2xl font-bold text-blue-700">
            ...
            <p>
              The stability of distribution networks must be examined and
              maintained using power analysers.
            </p>
            <ul className="ml-5 list-disc space-y-4">
              <li>
                Network analyser for investigating stability problems in
                distribution networks
              </li>
              <li>
                Mast & wall mounting - with housing ideal for monitoring power
                distribution in harsh environmental conditions
              </li>
              <li>Detecting cyber attacks on substations</li>
              <li>Recording of performance parameters with 150kHz bandwidth</li>
              <li>
                Environmental Information can be determined alongside Power
                Readings
              </li>
            </ul>
          </div>
