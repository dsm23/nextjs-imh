  ...
  <section id="cards">
    ...
    <div className="grid grid-cols-1 gap-2 md:grid-cols-2 lg:grid-cols-3">
      <div className="elevation space-y-4 rounded-sm p-3">
        ...
        <Image
          src={refPQube3 satisfies StaticImageData}
          alt="PQube 3"
          className="block"
          placeholder="blur"
        />
        ...
        <ul className="mt-4 ml-5 list-disc space-y-4">
          <li>
            Specially configurable power meter for railway applications, tram
            and metro work
          </li>
          <li>
      ...
      <div className="elevation space-y-4 rounded-sm p-3">
        ...
        <Image
          src={refPQube3e satisfies StaticImageData}
        ...
        <p>
          Smart grids for generating, storing and consuming electricity require
          monitoring with power analysers
        </p>
        <ul className="mt-4 ml-5 list-disc space-y-4">
          <li>
            Power meter for monitoring various systems in decentralized energy
            generation
          </li>
          <li>Reliably monitor and control smart grids</li>
          <li>
            E-mail notification in the event of malfunctions in decentralized
            energy producers
          </li>
          <li>
            Optimise power grids thanks to detailed reports in daily, weekly and
            monthly trends
          </li>
          <li>
            Solar Panel DC Input voltage and DC current can be measured
            simultaneously with inverter 3 Phase output using just one PQube3
          </li>
        </ul>
      </div>
      <div className="elevation space-y-4 rounded-sm p-3">
        ...
        <ul className="ml-5 list-disc space-y-4">
          <li>
            Remote monitoring of electronic devices in hospitals, clinics and
            health centres
          </li>
          ...
          <li>
            ...
            devices and monitors for harmonics generated by high energy X-Ray
            Machines
          </li>
        </ul>
      </div>
      <div className="elevation space-y-4 rounded-sm p-3">
        ...
        <Image
          src={refPQube3v satisfies StaticImageData}
          alt="PQube 3v"
          className="block"
          placeholder="blur"
        />
        ...
        <p>
          ...
          emergency generator power supplies - power analysers detect faults at
          an early stage.
        </p>
        <ul className="ml-5 list-disc space-y-4">
          <li>
          ...
          <li>
            Local colour screen gives immediate information regarding circuit
            status to on site personnel
          </li>
          <li>Changes in load behaviour are instantly identified</li>
          <li>
            The PQube3 has 2 direct environmental sensor inputs for in-cabinet
            and room temperature determinations, plus additional analog inputs
            for other sensors so that the HEAT produced in-situ can be monitored
          </li>
        </ul>
      </div>
      <div className="elevation space-y-4 rounded-sm p-3">
        ...
        <Image
          src={refPQube3r satisfies StaticImageData}
          alt="PQube 3r"
          className="block"
          placeholder="blur"
        />
        ...
        <p>
          Faults in the energy supply can destroy the electronics and must be
          detected early with power analysers.
        </p>
        <ul className="ml-5 list-disc space-y-4">
          <li>Power meter for monitoring various electrical parameters</li>
          <li>Quickly identify the causes of problems in the energy network</li>
          <li>
            Prevent damage to device and machine electronics due to disruptions
            in the energy flow
          </li>
          <li>
            Efficient maintenance of machines thanks to detailed reports from
            the meter - often obtained remotely from capital industrial devices
            installed in customer locations around the world
          </li>
        </ul>
      </div>
      <div className="elevation space-y-4 rounded-sm p-3">
        ...
        <p>
          For on-site measurements, a compact measuring device for field use is
          required.
        </p>
        ...
        <ul className="ml-5 list-disc space-y-4">
          ...
          <li>
            ...
            Comparing week by week and month by month data, fault conditions can
            be predicted
          </li>
          <li>
            Convenient customer service from a distance - monitoring from your
            own computer or smartphone
          </li>
      ...
      <div className="elevation space-y-4 rounded-sm p-3">
        ...
        <ul className="ml-5 list-disc space-y-4">
          <li>
            Monitoring of energy flow and various current values in industrial
            and production systems according to SEMI F47
          </li>
          <li>Power meter for recording 1-phase and 3-phase loads</li>
          <li>
            Recording of environmental values such as temperature, humidity and
            air pressure
          </li>
          <li>Optimizing energy management in production and industry</li>
          <li>
            The PQube3e can monitor 4 separate 3 Phase feeds - all with just the
            one instrument.
          </li>
        </ul>
      </div>
      ...
      <div className="elevation space-y-4 rounded-sm p-3">
        ...
        <p>
          The stability of distribution networks must be examined and maintained
      ...
      <div className="mt-6 grid items-center gap-x-5 gap-y-4 md:grid-cols-2 lg:grid-cols-[3fr_2fr]">
        <div>
          <p className="mt-4">
            ...
            loggers, plus in the UK, Powerside{"'"}s (formerly Power Standards
            Lab) range of remote access PQube power monitors. In addition, IMH
            can show the QubeScan and PQView software for controlling a fleet of
        ...
        <Image
          src={refConfRoom satisfies StaticImageData}
